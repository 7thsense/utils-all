...
object OAuth2Service extends Logging {
  ...
  )(implicit logContext: TLogContext): String = {
    require(
  ...
  )(implicit logContext: TLogContext): OAuth2Credential = {
  ...
  )(implicit logContext: TLogContext): Either[Error, OAuth2TokenResponse] =
    result.status match {
      case 200 =>
